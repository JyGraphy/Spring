...
public class Ex02Controller {
	...
	public String ex02(MultipartFile upload, RedirectAttributes rttr) throws IllegalStateException, IOException {	
		...
		upload.transferTo(f);
		// 사용자가 전송한 upload를 지정한 위치의 파일 f로 전송한다
