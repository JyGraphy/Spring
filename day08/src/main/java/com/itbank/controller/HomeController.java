...
//		try {
			...
			mav.addObject("today", today);	// - simpleDateFormat
			
//		} catch (NullPointerException e) {
//			System.out.println("예외 발생" + e);
//		}
		
//		mav.addObject("date", date);	// -Date , taglib fmt
		return mav;
	}
		@ExceptionHandler(NullPointerException.class)		// 지정한 클래스 타입의 예외가 현제 컨트롤러에서 발생하면
