...
<body>
	...
	<form method="POST" enctype="multipart/form-data">
		...
		<!-- private MultipartFile upload; -> Upload1DTO -->
	...
	<div style="display: flex; flex-flow: wrap; width: 900px; margin: auto;">
		<c:forEach var="dto" items="${list }">
			<div class="item" style="margin:  10px; text-align: center; width: 200px; background-color: #eee;">
				<p><img alt="" src="${cpath }/upload/${dto.storedFileName }" height="150"></p>
				...
				<p>
					...
					<!-- 새탭에서 보고 싶을때 사용 ->  target="_blank" -->
					<!-- download 때문에 새탭으로 넘어가지 않고 바로 다운로드가 실행된다 -->
